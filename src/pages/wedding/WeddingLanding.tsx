...
const WeddingLanding = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen">
      {/* Hero Section with Irregular Video */}
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                Capturing
                <br />
                <span className="italic font-serif text-[#d4a574]">Timeless</span>
                <br />
                Love Stories
              </motion.h1>
            </div>
            ...
            <motion.p 
              ...
              transition={{ delay: 1 }}
            >
              We create photographs and films that transcend time, 
              preserving your most precious moments in cinematic artistry.
            </motion.p>
          ...
          >
            {/* Irregular blob shape with video */}
            <div className="relative w-full aspect-[4/5]">
              {/* Main irregular video container */}
              <motion.div
                className="absolute inset-0 overflow-hidden"
                style={{
                  clipPath: "polygon(25% 0%, 100% 0%, 100% 85%, 75% 100%, 0% 100%, 0% 15%)",
                }}
                animate={{
                  clipPath: [
          ...
          >
            <div className="space-y-8">
              ...
              <p className="text-[#f5f0e8]/60 text-lg leading-relaxed">
                For almost a decade, Wedding by TMF has been creating photographs 
                and films which are timeless and have been etched in the memories 
                of thousands of people forever. Our work transcends traditional 
                wedding documentation, creating art that tells your unique love story.
              </p>
              <div className="flex gap-8 pt-4">
                <div>
                  <span className="text-4xl font-light text-[#d4a574]">500+</span>
                  <p className="text-[#f5f0e8]/60 text-sm uppercase tracking-wider mt-2">Weddings Captured</p>
                </div>
                <div>
                  <span className="text-4xl font-light text-[#d4a574]">10+</span>
      ...
      <section className="py-32 px-8 bg-[#f5f0e8]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-light text-[#1a1a1a] mt-4">
              Featured Stories
            </h2>
          </motion.div>
      ...
      <section className="py-32 px-8 bg-[#1a1a1a] relative overflow-hidden">
        {/* Background video with irregular mask */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-[#f5f0e8]/60 text-lg max-w-2xl mx-auto">
              Our wedding films are crafted with the same passion and attention to detail 
              as our photography, creating cinematic memories that will last forever.
            </p>
            <Link
              to="/works/wedding-by-tmf/films"
      ...
      <section className="py-32 px-8 bg-[#f5f0e8]">
        ...
        >
          ...
          <p className="text-[#1a1a1a]/60 text-lg mb-12 max-w-2xl mx-auto">
            Every love story deserves to be told in its own unique way. 
            Reach out to discuss how we can capture yours.
          </p>
          <Link
            to="/about"
